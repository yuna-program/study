...
public class RequestParamController {
	...
	@ResponseBody // view 를 반환하지않고, http message body에 직접 텍스트 반환 (=@RestController 랑 같은 기능)
